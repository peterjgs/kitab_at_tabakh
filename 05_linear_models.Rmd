...
reg1 <- read.csv("data/elemapi2.csv")
...
totalC <- read.csv("data/total carbon.csv")
...
cycle <- read.table("data/cycling.txt", header = T)
...
waterQual <- read.table("data/waterQual.txt", header = T)
